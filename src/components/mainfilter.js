...
export default function Mainfilter() {
  ...
  const handleChangeSuburb = (event) => {
    ...
    if(event.target.value.includes("Albany")){
      setfilteredresult(backendresult.filter(listing=>listing.suburb==="Albany"))}
    else if(event.target.value.includes("Epsom")){setfilteredresult(backendresult.filter(listing=>listing.suburb==="Epsom"))}
    else if(event.target.value.includes("Parnell")){setfilteredresult(backendresult.filter(listing=>listing.suburb==="Parnell"))}
    else if(event.target.value.includes("CBD")){setfilteredresult(backendresult.filter(listing=>listing.suburb==="CBD"))}
    else if(event.target.value.includes("Howick")){setfilteredresult(backendresult.filter(listing=>listing.suburb==="Howick"))}
    else if(event.target.value.includes("Flat Bush")){setfilteredresult(backendresult.filter(listing=>listing.suburb==="Flat Bush"))};
  ...
  return (
    ...
    <div>
      ...
      <Button variant="contained" onClick={finalarray}>Search</Button>
